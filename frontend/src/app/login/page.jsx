...
function LoginPage() {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-custom-color-blue-400 to-custom-color-green-400">
      <div className="max-w-lg mx-auto p-20 bg-gradient-to-r from-custom-color-blue-400 to-custom-color-green-400 rounded-lg shadow-lg space-y-6">
        ...
        <form className="max-w-lg mx-auto p-20  rounded-lg  space-y-6">
          <label
            htmlFor="userName"
